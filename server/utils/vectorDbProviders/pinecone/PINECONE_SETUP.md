# How to setup Pinecone Vector Database for bridge
...
**Note:** [Namespaces are not supported in `gcp-starter` environments](https://docs.pinecone.io/docs/namespaces) and are required to work with bridge.
