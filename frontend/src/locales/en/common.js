const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Welcome to bridge, bridge is complex set of AI tools and models by Arvo AI that gives you access to trained chatbots you can query with your documents.",
    part2:
      "bridge is the easiest way to put powerful AI products like OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB, and other services together in a neat package with no fuss to increase your productivity by 100x.",
    part3:
      "bridge can run with little overhead you wont even notice it's there! No GPU needed. \nThe AI tooling ecosystem gets more powerful everyday. bridge makes it easy to use.",
    ...
    part5:
      "bridge is more than a smarter Dropbox.\n\nbridge offers two ways of talking with your data:\n\n<i>Query Mode:</i> Your chats return data or inferences based on the documents in your workspace. The more documents you add, the smarter Bridge becomes! \n\n<i>Conversational Mode:</i> Both your documents and the ongoing chat history contribute to the LLM's knowledge simultaneously. This is perfect for appending real-time information or correcting misunderstandings the LLM might have. \n\nYou can switch between either mode \n<i>in the middle of chatting!</i>",
    user3: "Wow, this sounds amazing, let me try it out already!",
    part6: "Have Fun!",
    starOnGithub: "Star on GitHub",
    contact: "Contact Arvo AI",
  },
  ...
  appearance: {
    ...
    message: {
      ...
      user: "user",
      message: "message",
      assistant: "bridge Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this bridge instance.",
  ...
  llm: {
    ...
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. Its important these keys are current and correct or else bridge will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall bridge when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which bridge can use to process.",
    provider: {
      title: "Embedding Provider",
      description:
        "There is no set up required when using bridge's native embedding engine.",
    },
  },
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your bridge instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protect your bridge instance with a password. If you forget this there is no recovery method so ensure you save this password.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and bridge handle your data.",
    llm: "LLM Selection",
