...
import bridgeIcon from "@/media/logo/bridge-icon.png";
...
export const LLM_SELECTION_PRIVACY = {
  ...
  native: {
    ...
    description: [
      "Your model and chats are only accessible on this bridge instance",
    ],
    logo: bridgeIcon,
  },
  togetherai: {
...
export const VECTOR_DB_PRIVACY = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of bridge",
    ],
    logo: LanceDbLogo,
  },
};
...
export const EMBEDDING_ENGINE_PRIVACY = {
  native: {
    name: "bridge Embedder",
    description: [
      "Your document text is embedded privately on this instance of bridge",
    ],
    logo: bridgeIcon,
  },
  openai: {
